describe('controller: WriterManagementController', function () {
  ...
  var initializeController = function(settings) {
    inject(function ($controller, $rootScope, _InternalMetadata_, _InternalMetadataRepo_, _Reader_, _ReaderRepo_, _Source_, _SourceRepo_, _User_, _UserService_, _Writer_) {
      scope = $rootScope.$new();
